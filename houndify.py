...
class TextHoundClient(_BaseHoundClient):
    def __init__(self, userID, hostname = HOUND_SERVER, proxyHost = None, proxyPort = None, proxyHeaders = None):
      '''
      Parse data from config file
      '''
      clientID, clientKey = get_config_authentication()
      latitude, longitude = get_config_location()
      requestInfo = get_config_request_info()
...
class StreamingHoundClient(_BaseHoundClient):
    ...
    def __init__(self, userID, hostname = HOUND_SERVER, sampleRate = 16000, useSpeex = True, proxyHost = None, proxyPort = None, proxyHeaders = None):
      clientID, clientKey = get_config_authentication()
      latitude, longitude = get_config_location()
      requestInfo = get_config_request_info()
